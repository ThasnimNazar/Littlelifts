...
const occasionalSittingSchema = new mongoose_1.Schema({
    sittingCategory: {
...
const OccasionalSitting = mongoose_1.default.model('OccasionalSitting', occasionalSittingSchema);
exports.default = OccasionalSitting;
