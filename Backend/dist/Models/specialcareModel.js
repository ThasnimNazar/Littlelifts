...
const specialcareSittingSchema = new mongoose_1.Schema({
    sittingCategory: {
...
const SpecialCareSitting = mongoose_1.default.model('SpecialCareSitting', specialcareSittingSchema);
exports.default = SpecialCareSitting;
