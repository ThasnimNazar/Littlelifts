...
const Managesittingcategory: React.FC = () => {
    ...
    const handleAddCategory = () => {
        navigate('/admin/adminhome/add-category');
    };

    useEffect(() => {
        const fetchCategory = async () => {
            try {
                const response = await axios.get<ResponseData>('/api/admin/get-sittingcategory');
            ...
            render: ({ onClose }) => (
                <div>
                    <button
                        onClick={async () => {
                            try {
                                await axios.delete(`/api/admin/delete-sittingcategory/${categoryId}`);
    ...
    return (
        <>
            ...
            <div className="container p-2 mx-auto sm:p-4 dark:text-gray-800">
                <h2 className="mb-4 text-2xl font-semibold leading-tight">Sitting Categories</h2>
...
export default Managesittingcategory       