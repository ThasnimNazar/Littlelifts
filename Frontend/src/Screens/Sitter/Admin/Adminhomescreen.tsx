...
const Adminhomescreen: React.FC = () => {
	...
	<div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
		...
		<div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
			<img src="https://media.istockphoto.com/id/1493276734/vector/data-analytic-scene-trendy-business-character-financial-management-illustration-personal.jpg?s=612x612&w=0&k=20&c=zctyc3Iev_DoBo7hCV23PPS63-5-KkXwgg0sxfckJyM=" alt="" className="object-contain h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128" />
		</div>
	</div>
</section>
        </>
